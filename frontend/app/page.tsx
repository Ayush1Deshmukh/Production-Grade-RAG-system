    ...
    <main className={styles.main}>
      ...
      <header className={styles.header}>
        ...
        <p className={styles.subtitle}>
          Hybrid search · Cross-encoder re-ranking · Citation-enforced answers · Gemini generation
        </p>
        <div className={styles.techPills}>
          {["LangChain", "Qdrant", "MS-MARCO Rerank", "Gemini", "Ragas CI/CD"].map((t) => (
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerText}>
          Built with LangChain · Qdrant Cloud · HuggingFace · Gemini · Ragas
        </div>
      </footer>
    </main>
  );
